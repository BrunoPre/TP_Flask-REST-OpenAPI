...
_MOVIEDIRECTOR = _descriptor.Descriptor(
  name='MovieDirector',
  full_name='MovieDirector',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='director', full_name='MovieDirector.director', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MOVIERATE = _descriptor.Descriptor(
  name='MovieRate',
  full_name='MovieRate',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='rating', full_name='MovieRate.rating', index=0,
...
_MOVIEIDANDRATE = _descriptor.Descriptor(
  name='MovieIDAndRate',
  full_name='MovieIDAndRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='MovieIDAndRate.id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rating', full_name='MovieIDAndRate.rating', index=1,
...
_MOVIEIDANDRATE.fields_by_name['id'].message_type = _MOVIEID
_MOVIEIDANDRATE.fields_by_name['rating'].message_type = _MOVIERATE
DESCRIPTOR.message_types_by_name['MovieID'] = _MOVIEID
DESCRIPTOR.message_types_by_name['MovieTitle'] = _MOVIETITLE
DESCRIPTOR.message_types_by_name['MovieDirector'] = _MOVIEDIRECTOR
DESCRIPTOR.message_types_by_name['MovieData'] = _MOVIEDATA
DESCRIPTOR.message_types_by_name['MovieRate'] = _MOVIERATE
DESCRIPTOR.message_types_by_name['MovieIDAndRate'] = _MOVIEIDANDRATE
...
MovieIDAndRate = _reflection.GeneratedProtocolMessageType('MovieIDAndRate', (_message.Message,), {
  'DESCRIPTOR' : _MOVIEIDANDRATE,
  '__module__' : 'movie_pb2'
  # @@protoc_insertion_point(class_scope:MovieIDAndRate)
  })
_sym_db.RegisterMessage(MovieIDAndRate)
...
_MOVIE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=6,
    containing_service=None,
    input_type=_MOVIEIDANDRATE,
    output_type=_MOVIEDATA,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteMovieByRate',
    full_name='Movie.DeleteMovieByRate',
    index=7,
    containing_service=None,
    input_type=_MOVIERATE,
    output_type=_EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
